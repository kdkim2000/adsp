      ...
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-6">
        <div className="q-card space-y-6">
          <div className="text-center space-y-2">
            ...
            <h1 className="text-2xl font-display font-bold text-ink">ADsP 모의고사</h1>
          ...
          <div className="text-left bg-primary-50 border border-primary-200 rounded-xl px-4 py-3 text-sm space-y-1">
            ...
            <div className="text-primary-700">• 1~2과목 10문항, 3과목 30문항</div>
          </div>
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-lg font-bold text-ink">ADsP 모의고사</h1>
